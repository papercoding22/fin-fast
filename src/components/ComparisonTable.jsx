    ...
    <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
      <div className="px-6 py-4 border-b border-slate-100">
        ...
        <p className="text-xs text-slate-500 mt-1">
          Màu xanh lá = chi phí thấp nhất trong kịch bản
        </p>
      </div>
        ...
        {banks.map((bank) => (
          <div key={bank.id} className="flex items-center gap-2">
            ...
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.backgroundColor = bank.color;
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {scenarios.map((scenario) => {
              ...
              const costs = banks.map(
                (b) => scenarioResults[b.id]?.costExcludingPrincipal ?? Infinity
              );
                  ...
                  >
                    ...
                    <td className="px-4 py-3 whitespace-nowrap">
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <span style={{ color: bank.color }} className="font-medium">
                          {bank.name}
                        </span>
                        {isBest && (
                    ...
                    <td
                      ...
                      style={{ color: isBest ? "#16a34a" : "#1e293b" }}
                    >
